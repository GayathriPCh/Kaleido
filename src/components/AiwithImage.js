...
const AiwithImage = () => {
    ...
    async function aiImageRun() {
        ...
        const result = await model.generateContent([
            "Describe the colors in this photo ,the art style, and to which art period do you think they belong to?", imageInineData
        ]);
    ...
    return (
        <div>
            ...
            <div>
                ...
                <img src={image} alt="Meaningful description"style={{ width: '30%', marginTop: 30 }} />
            </div>
